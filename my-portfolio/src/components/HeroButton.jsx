...
const HeroButton = () => {
  return (
    <button className="relative inline-flex items-center justify-center px-9 py-3 overflow-hidden tracking-tighter text-white bg-gray-900 rounded-md group">
      <span className="absolute w-0 h-0 transition-all duration-500 ease-out bg-gray-600 rounded-full group-hover:w-56 group-hover:h-56" />
      ...
      <span className="relative text-base font-semibold">View my projects</span>
    </button>
  );
}
